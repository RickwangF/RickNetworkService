...
@objc public enum RickHTTPMethod: Int {
    case post = 1, get = 2, put = 3, delete = 4
}

@objcMembers public class NetworkTool: NSObject {
    ...
    class public func request(_ base: String,
        ...
        case .JSON:
            request.responseJSON { (responseObject) in
                // 打印网络请求的完整信息
                NetworkDebugLog.printDebugInfo(responseObject)
